...
namespace Database
{
    ...
    {
        [DllImport("Main")]
        public static extern bool InitGameDataSystem([MarshalAs(UnmanagedType.LPUTF8Str)] string dataPath, [MarshalAs(UnmanagedType.LPUTF8Str)] string localizationExtension,
        ...
        [DllImport("Main")]
        public static extern bool InitEditorDataSystem([MarshalAs(UnmanagedType.LPUTF8Str)] string dataPath, [MarshalAs(UnmanagedType.LPUTF8Str)] string localizationExtension,
                                                       [MarshalAs(UnmanagedType.I1)] bool noRcs, [MarshalAs(UnmanagedType.LPUTF8Str)] string rcsConfigFile);

        [DllImport("libdb", EntryPoint = "?GetMainDatabase@NDb@@YAPAVCBasicDatabase@1@XZ", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libdb", EntryPoint = "?GetObject@CGameDatabase@NDb@@UAEPAVCResource@2@ABVDBID@@@Z", CallingConvention = CallingConvention.ThisCall)]
        public static extern IntPtr GetObject(IntPtr database, IntPtr dbid);

        [DllImport("libdb", EntryPoint = "?DoesObjectExist@CGameDatabase@NDb@@EAE_NABVDBID@@@Z", CallingConvention = CallingConvention.ThisCall)]
