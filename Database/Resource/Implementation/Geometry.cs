...
namespace Database.Resource.Implementation
{
    public class Geometry : Resource
    {
        ...
        [MemoryArrayOffset(304, 20)] [XdbArray]
        public FlareInfo[] FlareInfos;
        ...
        [MemoryArrayOffset(224, 20)] [XdbArray]
        public NamedJoint[] Joints;
        ...
        [MemoryArrayOffset(180, 112)] [XdbArray]
        public ModelElement[] ModelElements;

        [MemoryArrayOffset(164, 60)] [XdbArray]
        public OccluderInfo[] OccluderInfos;

        [MemoryOffset(160)] [XdbElement] public Bool OptimizeMesh;

        [MemoryOffset(156)] [XdbEnum(typeof(OrientationMode))]
        public Int OrientationMode;

        [MemoryArrayOffset(140, 68)] [XdbArray]
        ...
        [MemoryOffset(68)] [XdbElement("sourceFileCRC")]
