...
namespace Database.Resource.Implementation
{
    ...
    {
        [MemoryOffset(244)] [XdbElement("BackLayer")]
        public FileRef BackLayer;

        [MemoryArrayOffset(88, 32)] [XdbArray] public BindSection[] BindSections;

        [MemoryArrayOffset(228, 8)] [XdbArray("Children")]
        public FileRef[] Children;

        [MemoryOffset(84)] [XdbElement] public Bool ClipContent;

        [MemoryOffset(224)] [XdbElement("Enabled")]
        public Bool Enabled;

        [MemoryOffset(80)] [XdbElement] public Float Fade;
        [MemoryOffset(68)] [XdbElement] public AsciiString ForceReactionOnPointing;

        [MemoryOffset(216)] [XdbElement("FrontLayer")]
        public FileRef FrontLayer;

        [MemoryOffset(212)] [XdbElement("IgnoreDblClick")]
        public Bool IgnoreDblClick;

        [MemoryOffset(200)] [XdbElement("Name")]
        public AsciiString Name;

        [MemoryOffset(196)] [XdbElement("PickChildrenOnly")]
        ...
        [MemoryOffset(108)] [XdbElement("TabOrder")]
        public Int TabOrder;

        [MemoryOffset(105)] [XdbElement("TransparentInput")]
        public Bool TransparentInput;

        [MemoryOffset(104)] [XdbElement("Visible")]
        public Bool Visible;
        ...
        public class BindSection : Resource
        {
            ...
            [MemoryOffset(20)] [XdbElement("bindSection")]
            public AsciiString MBindSection;
        }
    }
}