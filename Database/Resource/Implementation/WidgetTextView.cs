...
namespace Database.Resource.Implementation
{
    public class WidgetTextView : Widget
    {
        ...
        [MemoryOffset(304)] [XdbElement("FormatFileRef")]
        ...
        [MemoryOffset(284)] [XdbElement("TextStyle")]
        public WidgetTextStyle TextStyle;

        [MemoryArrayOffset(268, 32)] [XdbArray("TextValues")]
        public WidgetTextTaggedValue[] TextValues;
